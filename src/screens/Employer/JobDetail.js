    ...
    return (
        <Card className="mt-4">
            ...
            <Card.Body>
                ...
                {/* HIỂN THỊ THỜI GIAN LÀM VIỆC Ở ĐÂY */}
                <p>
                ...
                <p>
                    ...
                    {
                        job.status ?
                            <Badge bg="success">Đang tuyển</Badge>
                            :
                            <Badge bg="danger">Đã đóng</Badge>
                    }
                </p>
                <hr />
                    ...
                    {user?.role === "EMPLOYER" && (
                        <>
                            ...
                            <Link to={`/employer/jobs/${job.id}/applications`}>
                                <Button variant="primary">Danh sách ứng tuyển</Button>
                            </Link>
                        </>
                    )}
                    ...
                    {user?.role === "STUDENT" && (
                        <>
                            <Link to={`/companies/${job.company_id || job.company?.id}`}>
                                <Button variant="info" className="text-white">Xem thông tin công ty</Button>
                            </Link>           
            ...
            >
                ...
                <Modal.Body>
                    {
                        cvs.length === 0 ?
                            <p>Bạn chưa có CV. Hãy tạo CV trước.</p>
                            :
                            <Form.Group>
